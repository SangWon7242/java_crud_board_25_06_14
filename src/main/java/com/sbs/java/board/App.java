...
public class App {
  ...
  void actionArticleDoDelete(Rq rq) {
  ...
  void actionArticleDoModify(Rq rq) {
    Map<String, String> params = rq.getParams();
  ...
  void actionArticleDoWrite(Rq rq) {
  ...
  void actionArticleShowDetail(Rq rq) {
    Map<String, String> params = rq.getParams();
  ...
  void actionArticleShowList(Rq rq) {
    if (articles.isEmpty()) {
      System.out.println("게시물이 존재하지 않습니다.");
      return;
    }
  ...
  Article findById(List<Article> articles, int id) {
